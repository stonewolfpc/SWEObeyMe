  ...
  return [
    {
      ...
      priority: 75,
      description: 'C# ERROR ANALYSIS - Get all C# errors in the workspace. Returns errors with severity levels (Info/Warning/Error), line ranges, and file paths. Use this when: checking overall C# code quality across the workspace before making changes. CRITICAL for understanding C# code quality.',
      inputSchema: {
        type: 'object',
        properties: {
          severityThreshold: {
    ...
    },
    {
      ...
      priority: 80,
      description: 'UNDO SURGICAL EDIT - Restore a C# file from its most recent backup. Use this when: a surgical edit introduced errors or you need to revert to the previous state. CRITICAL for error recovery.',
      inputSchema: {
        type: 'object',
        properties: {
