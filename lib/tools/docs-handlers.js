...
const CORPUS_REGISTRY = {
  ide: {
    name: 'IDE / MCP Corpus',
    description: 'Windsurf, MCP spec, VS Code API, OpenVSX, agentic patterns, quantization, LLM, testing, and 35+ technical categories from ide_mcp_corpus/',
