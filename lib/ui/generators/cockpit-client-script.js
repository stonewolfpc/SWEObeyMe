...
export function getClientScript() {
  return `
    ...
    function handleErrorResponse(data) {
      ...
      // Update status dot color based on severity
      if (data.worstSeverity === 'critical') {
        dot.style.backgroundColor = '#ff3d71';
        dot.style.boxShadow = '0 0 8px #ff3d71';
      } else if (data.worstSeverity === 'error') {
        dot.style.backgroundColor = '#ff6b2b';
        dot.style.boxShadow = '0 0 8px #ff6b2b';
      } else if (data.worstSeverity === 'warning') {
        dot.style.backgroundColor = '#ffab00';
        dot.style.boxShadow = '0 0 8px #ffab00';
      } else {
        dot.style.backgroundColor = '#00e676';
        dot.style.boxShadow = '0 0 8px #00e676';
      }
