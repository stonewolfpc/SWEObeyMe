...
export const autonomousHandlers = {
  ...
  autonomous_execute: async args => {
    ...
    if (AUTONOMOUS_EXECUTION_PROFESSIONAL_ONLY()) {
      return {
        isError: true,
        content: [
          { type: 'text', text: 'Autonomous execution is in PROFESSIONAL ONLY mode. Disable "autonomousExecutionProfessionalOnly" in configuration to enable.' },
        ],
      };
    }
    ...
    try {
      ...
      return {
        isError: true,
        content: [
          { type: 'text', text: `Autonomous execution failed: ${error.message}` },
        ],
      };
    }
  },
  ...
  autonomous_pause: async args => {
    ...
    try {
      ...
      return {
        content: [
          { type: 'text', text: 'Autonomous execution paused' },
        ],
      };
    } catch (error) {
      return {
        isError: true,
        content: [
          { type: 'text', text: `Failed to pause: ${error.message}` },
        ],
      };
    }
  },
  ...
  autonomous_resume: async args => {
    ...
    try {
      ...
      return {
        isError: true,
        content: [
          { type: 'text', text: `Failed to resume: ${error.message}` },
        ],
      };
    }
  },
  ...
  autonomous_cancel: async args => {
    ...
    try {
      ...
      return {
        content: [
          { type: 'text', text: 'Autonomous execution cancelled' },
        ],
      };
    } catch (error) {
      return {
        isError: true,
        content: [
          { type: 'text', text: `Failed to cancel: ${error.message}` },
        ],
      };
    }
  },
  ...
  autonomous_plan: async args => {
    ...
    try {
      ...
      return {
        isError: true,
        content: [
          { type: 'text', text: `Failed to generate plan: ${error.message}` },
        ],
      };
    }
  },
  ...
  autonomous_enable: async args => {
    ...
    if (!ENABLE_AUTONOMOUS_EXECUTION()) {
      return {
        isError: true,
        content: [
          { type: 'text', text: 'Autonomous execution is disabled in configuration. Enable "enableAutonomousExecution" to use this feature.' },
        ],
      };
    }
    ...
    try {
      ...
      return {
        content: [
          { type: 'text', text: 'Autonomous mode enabled' },
        ],
      };
    } catch (error) {
      return {
        isError: true,
        content: [
          { type: 'text', text: `Failed to enable autonomous mode: ${error.message}` },
        ],
      };
    }
  },
  ...
  autonomous_disable: async args => {
    ...
    try {
      ...
      return {
        isError: true,
        content: [
          { type: 'text', text: `Failed to disable autonomous mode: ${error.message}` },
        ],
      };
    }
  },
