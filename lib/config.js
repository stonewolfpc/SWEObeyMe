...
export const AUTONOMOUS_EXECUTION_PROFESSIONAL_ONLY = () => config.autonomousExecutionProfessionalOnly;
...
export const AUTONOMOUS_PAUSE_ON_USER_INPUT_REQUIRED = () => config.autonomousPauseOnUserInputRequired;
