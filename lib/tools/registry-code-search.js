  ...
  return [
    {
      name: 'search_code',
      priority: 70,
      description: 'CODE SEARCH SWISS-ARMY-KNIFE - Search files, patterns, or languages. Get language statistics, detect file types, or find all files by language. This is your swiss-army-knife for code discovery. Use this when: searching for code patterns, finding files by language, getting project language stats, or detecting file types. Example: search_code with operation="files" to find all Python files in a project.',
      inputSchema: {
        type: 'object',
        properties: {
          operation: {
