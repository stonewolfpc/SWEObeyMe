...
- Testing and Publishing includes in-depth guides on various extension development topics, such as testing and [publishing](https://code.visualstudio.com/api/working-with-extensions/publishing-extension) extensions.
- Advanced Topics explains advanced concepts such as Extension Host, Supporting Remote Development and GitHub Codespaces, and [Proposed API](https://code.visualstudio.com/api/advanced-topics/using-proposed-api).
