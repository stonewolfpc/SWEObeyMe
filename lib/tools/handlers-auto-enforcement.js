...
import { getAutoEnforcement, initializeAutoEnforcement } from '../auto-enforcement.js';
import { readFileWithSizeLimit } from '../shared/async-utils.js';
import fs from 'fs/promises';
import path from 'path';

/**
 * Ensure auto enforcement is initialized before use (lazy init).
