...
export const toolHandlers = {
  ...
  // 2. swe_search_code - Search the codebase
  swe_search_code: codeSearchHandlers.swe_search_code,
  ...
  // 6. swe_workflow_manage - Workflow orchestration
  swe_workflow_manage: workflowHandlers.swe_workflow_manage,

  // Session and safety management
  session_manage: workflowHandlers.session_manage,
  safety_check: safetyHandlers.safety_check,

  // Docs tools - direct access
  docs_verify: docsToolHandlers.docs_verify,
  docs_list_categories: docsToolHandlers.docs_list_categories,
