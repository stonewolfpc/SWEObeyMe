 ...
 * Routes to appropriate handler based on operation parameter
 */
export async function swe_workflow_manage_handler(params) {
...
export const workflowHandlers = {
  ...
  swe_workflow_manage: swe_workflow_manage_handler,
