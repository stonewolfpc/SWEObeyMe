...
export async function detect_project_type_handler(params) {
  ...
  if (!filePath) {
    return {
      content: [{ type: 'text', text: JSON.stringify({ success: false, error: 'filePath is required' }, null, 2) }],
      isError: false,
    };
  }
  ...
  if (!projectPath) {
    return {
      content: [{ type: 'text', text: JSON.stringify({ success: false, error: 'Could not determine project root from file path', projectType: PROJECT_TYPES.UNKNOWN }, null, 2) }],
      isError: false,
    };
  }
  ...
  return {
    content: [{ type: 'text', text: JSON.stringify({ success: true, projectPath, projectName: project.projectName, projectType, ruleSetName: PROJECT_RULE_SETS[projectType]?.name || 'No rule set' }, null, 2) }],
    isError: false,
  };
}
...
export async function detect_project_switch_handler(params) {
  ...
  if (announcement) {
    return {
      content: [{ type: 'text', text: JSON.stringify({ success: true, announcement, currentProject: manager.getCurrentProject() }, null, 2) }],
      isError: false,
    };
  }

  return {
    content: [{ type: 'text', text: JSON.stringify({ success: true, message: 'No project switch detected', currentProject: manager.getCurrentProject() }, null, 2) }],
    isError: false,
  };
}
...
export async function get_current_project_handler(params) {
  ...
  if (!currentProject) {
    return {
      content: [{ type: 'text', text: JSON.stringify({ success: false, error: 'No active project', currentProject: null }, null, 2) }],
      isError: false,
    };
  }
...
export async function validate_action_handler(params) {
  ...
  if (!action || !filePath) {
    return {
      content: [{ type: 'text', text: JSON.stringify({ success: false, error: 'action and filePath are required' }, null, 2) }],
      isError: false,
    };
  }
  ...
  return {
    content: [{ type: 'text', text: JSON.stringify({ success: true, valid: validation.valid, reason: validation.reason, currentProject: manager.getCurrentProject() }, null, 2) }],
    isError: false,
  };
}
...
export async function add_pending_task_handler(params) {
  ...
  if (!task) {
    return {
      content: [{ type: 'text', text: JSON.stringify({ success: false, error: 'task is required' }, null, 2) }],
      isError: false,
    };
  }
  ...
  return {
    content: [{ type: 'text', text: JSON.stringify({ success: true, message: 'Task added successfully', taskId: result.taskId, currentProject: manager.getCurrentProject() }, null, 2) }],
    isError: false,
  };
}
...
export async function get_project_rules_handler(params) {
  ...
  if (!targetProjectType) {
    return {
      content: [{ type: 'text', text: JSON.stringify({ success: false, error: 'No project type specified and no active project' }, null, 2) }],
      isError: false,
    };
  }
  ...
  return {
    content: [{ type: 'text', text: JSON.stringify({ success: true, projectType: targetProjectType, rules }, null, 2) }],
    isError: false,
  };
}
...
export async function switch_project_handler(params) {
  ...
  if (!projectPath) {
    return {
      content: [{ type: 'text', text: JSON.stringify({ success: false, error: 'projectPath is required' }, null, 2) }],
      isError: false,
    };
  }
...
export async function add_project_warning_handler(params) {
  ...
  if (!warning) {
    return {
      content: [{ type: 'text', text: JSON.stringify({ success: false, error: 'warning is required' }, null, 2) }],
      isError: false,
    };
  }
  ...
  return {
    content: [{ type: 'text', text: JSON.stringify({ success: true, message: 'Warning added successfully', currentProject: manager.getCurrentProject() }, null, 2) }],
    isError: false,
  };
}
...
export async function add_project_error_handler(params) {
  ...
  if (!error) {
    return {
      content: [{ type: 'text', text: JSON.stringify({ success: false, error: 'error is required' }, null, 2) }],
      isError: false,
    };
  }
  ...
  return {
    content: [{ type: 'text', text: JSON.stringify({ success: true, message: 'Error added successfully', currentProject: manager.getCurrentProject() }, null, 2) }],
    isError: false,
  };
}
...
export async function clear_pending_tasks_handler(params) {
  ...
  return {
    content: [{ type: 'text', text: JSON.stringify({ success: true, message: 'Pending tasks cleared successfully', currentProject: manager.getCurrentProject() }, null, 2) }],
    isError: false,
  };
}
...
export async function get_all_projects_handler(params) {
  ...
  return {
    content: [{ type: 'text', text: JSON.stringify({ success: true, projects, count: projects.length }, null, 2) }],
    isError: false,
  };
}
...
export async function set_current_task_handler(params) {
  ...
  return {
    content: [{ type: 'text', text: JSON.stringify({ success: true, message: 'Current task set successfully', currentProject: manager.getCurrentProject() }, null, 2) }],
    isError: false,
  };
}
...
export async function advance_task_handler(params) {
  ...
  return {
    content: [{ type: 'text', text: JSON.stringify({ success: true, message: result.message, nextTaskId: result.nextTaskId, currentProject: manager.getCurrentProject() }, null, 2) }],
    isError: false,
  };
}
...
export async function audit_tasks_handler(params) {
  ...
  return {
    content: [{ type: 'text', text: JSON.stringify({ success: true, audit, currentProject: manager.getCurrentProject() }, null, 2) }],
    isError: false,
  };
}
...
export async function archive_tasks_handler(params) {
  ...
  return {
    content: [{ type: 'text', text: JSON.stringify({ success: true, message: 'Task list archived successfully', currentProject: manager.getCurrentProject() }, null, 2) }],
    isError: false,
  };
}
...
export async function project_context_handler(params) {
  ...
  if (!operation) {
    return {
      content: [{ type: 'text', text: JSON.stringify({ success: false, error: 'operation parameter is required' }, null, 2) }],
      isError: false,
    };
  }
  ...
  switch (operation) {
    ...
    default:
      return {
        content: [{ type: 'text', text: JSON.stringify({ success: false, error: `Unknown operation: ${operation}` }, null, 2) }],
        isError: false,
      };
  }
}
