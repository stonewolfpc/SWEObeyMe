export function getToolDefinitions() {
  return [
    ...
    },
    {
      ...
      description:
        'Search code files for a pattern with language-aware ranking. Provides importance scoring based on language weight and context relevance. Example: Search for "class" to find class definitions across all supported languages.',
      inputSchema: {
        type: 'object',
        properties: {
          ...
          languages: {
            type: 'array',
            items: { type: 'string' },
            description: 'Array of languages to search (e.g., ["cpp", "python", "java"])',
          },
    ...
    },
    {
      ...
      description:
        'Get language statistics for a directory. Shows file counts per programming language. Example: Get stats to understand project language distribution.',
      inputSchema: {
        type: 'object',
        properties: {
    ...
    },
    {
      ...
      description:
        'Search by language-specific regex pattern. Allows complex pattern matching within specific languages. Example: Search for "class\s+\w+" in cpp to find class definitions.',
      inputSchema: {
        type: 'object',
        properties: {
    ...
    },
    {
      ...
      description:
        'Detect programming language from file extension. Identifies language based on file extension mapping. Example: Detect language for "main.py" returns "python".',
      inputSchema: {
        type: 'object',
        properties: {
    ...
    },
    {
      ...
      description:
        'Find all code files in a directory by language. Returns list of file paths for specified languages. Example: Find all Python files in a project directory.',
      inputSchema: {
        type: 'object',
        properties: {
          ...
          languages: {
            type: 'array',
            items: { type: 'string' },
            description: 'Array of languages to find (e.g., ["cpp", "python", "java"])',
          },
          excludeDirs: {
            type: 'array',
            items: { type: 'string' },
    ...
    },
    {
      ...
      description:
        'Search llama.cpp documentation for specific terms. Provides offline access to llama documentation without requiring internet. Documentation includes LlamaCpp.net .NET bindings and LlamaCppUnity for Unity. Example: Search for "Unity" or "model" to find relevant documentation.',
      inputSchema: {
        type: 'object',
        properties: {
    ...
    },
    {
      ...
      description:
        'List all available llama.cpp documentation files. Shows documentation files for LlamaCpp.net and LlamaCppUnity. Example: List available docs to see what llama documentation is available offline.',
      inputSchema: {
        type: 'object',
        properties: {},
      },
    ...
    },
    {
      name: 'list_math_docs',
      description:
        'List all available mathematical documentation files. Shows mathematical reference documentation for algorithm complexity, linear algebra, probability/statistics, and discrete mathematics. Example: List available math docs to see what mathematical documentation is available offline.',
      inputSchema: {
        type: 'object',
        properties: {},
      },
    ...
    },
    {
      ...
      description:
        'MUST use this tool to update C# Bridge configuration - this is the ONLY way to update analysis settings at runtime. Updates confidence threshold, deduplication, cooldown, and detector settings. Clears caches when configuration changes. Example: Update confidence threshold to 80 to reduce false positives.',
      inputSchema: {
        type: 'object',
        properties: {
