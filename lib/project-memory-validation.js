 ...
 * console.log(result.shouldSplit); // true if file should be split
 ...
 * console.log(result.valid); // true if location is valid
 * console.log(result.violations); // Array of violation objects
 */
 ...
 * console.log(result.valid); // false if naming convention violated
 * console.log(result.violations[0].suggestedName); // 'my-file.js'
 */
