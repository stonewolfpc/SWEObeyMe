...
function activate(context) {
  ...
  const installCommand = vscode.commands.registerCommand('sweObeyMe.installMCP', async () => {
  ...
  const oracleCommand = vscode.commands.registerCommand('sweObeyMe.queryOracle', async () => {
    const quotes = [
...
function checkAndInstallMCP() {
  ...
  // Windsurf Next requires absolute paths for MCP server paths
