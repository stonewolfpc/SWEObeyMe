...
export const toolHandlers = {
  ...
  read_file: async args => {
    ...
    try {
      ...
      // Add compact project map for orientation
      contextHeader += `=== PROJECT MAP ===\n`;
      contextHeader += `Entry Points: index.js (MCP server), extension.js (VSCode extension)\n`;
      contextHeader += `Core: lib/tools/ (62 MCP tools), lib/ (validation, enforcement, C# bridge)\n`;
...
Reminder: You are a surgeon. Precision over speed.`,
  ...
  search_code_files: codeSearchHandlers.search_code_files,
  get_code_language_stats: codeSearchHandlers.get_code_language_stats,
  search_code_pattern: codeSearchHandlers.search_code_pattern,
  detect_file_language: codeSearchHandlers.detect_file_language,
  find_code_files: codeSearchHandlers.find_code_files,
  search_llama_docs: codeSearchHandlers.search_llama_docs,
  list_llama_docs: codeSearchHandlers.list_llama_docs,
  search_math_docs: codeSearchHandlers.search_math_docs,
  list_math_docs: codeSearchHandlers.list_math_docs,
  ...
  get_csharp_errors: csharpHandlers.get_csharp_errors,
  get_csharp_errors_for_file: csharpHandlers.get_csharp_errors_for_file,
  get_integrity_report: csharpHandlers.get_integrity_report,
  toggle_csharp_error_type: csharpHandlers.toggle_csharp_error_type,
  set_csharp_ai_informed: csharpHandlers.set_csharp_ai_informed,
  update_csharp_config: csharpHandlers.update_csharp_config,
  undo_last_surgical_edit: csharpHandlers.undo_last_surgical_edit,
