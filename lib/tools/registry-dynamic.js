...
const PROJECT_TOOLSETS = {
  ...
  cpp: {
    ...
    optionalTools: ['get_file_context', 'analyze_change_impact', 'preflight_change', 'toggle_cpp_error_type', 'get_cpp_integrity_report'],
...
const CORPUS_TOOLS = {
  ...
  csharp: ['get_csharp_errors', 'get_csharp_errors_for_file', 'toggle_csharp_error_type', 'set_csharp_ai_informed', 'update_csharp_config', 'get_csharp_integrity_report', 'undo_last_surgical_edit'],
  cpp: ['get_cpp_errors', 'get_cpp_errors_for_file', 'toggle_cpp_error_type', 'set_cpp_ai_informed', 'update_cpp_config', 'get_cpp_integrity_report', 'undo_last_cpp_edit'],
  python: [],
};
