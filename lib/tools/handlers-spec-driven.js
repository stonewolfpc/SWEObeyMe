  ...
  spec_load: async args => {
    ...
    try {
      ...
      return {
        isError: true,
        content: [
          { type: 'text', text: `Failed to load specs: ${error.message}` },
        ],
      };
    }
  },
  ...
  spec_compliance: async args => {
    try {
      ...
      return {
        isError: true,
        content: [
          { type: 'text', text: `Failed to generate compliance report: ${error.message}` },
        ],
      };
    }
  },
  ...
  spec_verify: async args => {
    ...
    try {
      ...
      return {
        isError: true,
        content: [
          { type: 'text', text: `Failed to verify specs: ${error.message}` },
        ],
      };
    }
  },
  ...
  spec_update: async args => {
    ...
    if (!spec_type || !item_id || !status) {
      return {
        isError: true,
        content: [
          { type: 'text', text: 'spec_type, item_id, and status are required' },
        ],
      };
    }
    ...
    try {
      ...
      return {
        isError: true,
        content: [
          { type: 'text', text: `Failed to update spec: ${error.message}` },
        ],
      };
    }
  },
  ...
  spec_track: async args => {
    ...
    if (!file_path || !spec_item_ids) {
      return {
        isError: true,
        content: [
          { type: 'text', text: 'file_path and spec_item_ids are required' },
        ],
      };
    }
    ...
    try {
      ...
      return {
        isError: true,
        content: [
          { type: 'text', text: `Failed to track implementation: ${error.message}` },
        ],
      };
    }
  },
  ...
  spec_divergence: async args => {
    try {
      ...
      return {
        isError: true,
        content: [
          { type: 'text', text: `Failed to check divergences: ${error.message}` },
        ],
      };
    }
  },
