...
import { ENABLE_SYNTAX_VALIDATION, ENABLE_IMPORT_VALIDATION, ENABLE_ANTI_PATTERN_DETECTION, ENABLE_NAMING_VALIDATION } from "./config.js";
 ...
 */
export function validateSyntax(code, language = 'javascript') {
  const errors = [];
