  ...
  return [
    {
      ...
      priority: 85,
      description:
        'Swiss-army-knife for managing tool surface. Set project type, enable/disable corpora, or get tool registry stats. Use this when: starting work on a new project, switching project types, enabling documentation tools, or understanding current tool configuration.',
      inputSchema: {
        type: 'object',
        properties: {
          operation: {
