...
class PermissionManager {
  constructor() {
    this.perAgent = vscode.workspace.getConfiguration('sweObeyMe.toolControls').get('perAgent', true);
    this.fileAccess = vscode.workspace.getConfiguration('sweObeyMe.toolControls').get('fileAccess', 'ask');
    this.terminalAccess = vscode.workspace.getConfiguration('sweObeyMe.toolControls').get('terminalAccess', 'ask');
    this.networkAccess = vscode.workspace.getConfiguration('sweObeyMe.toolControls').get('networkAccess', 'ask');
  ...
  unregisterToolUse(toolType, agentId) {
    ...
    const otherAgentsUsingTool = Array.from(this.activeTools)
      .filter(k => k.startsWith(toolType) && k !== key);
