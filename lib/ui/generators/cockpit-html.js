...
<head>
  ...
  <title>SWEObeyMe v5.1.21 Cockpit</title>
  ...
  <div id="cockpit">
    ...
    <header class="cockpit-header">
      <div class="header-brand">
        ...
        <span class="brand-version">v5.1.21</span>
      </div>
      ...
      <div class="status-grid">
        <div class="status-card">
          ...
          <div class="status-content">
            ...
            <div class="status-value backup-gray" id="backupStatus">Backup Status: UNKNOWN</div>
            <div class="backup-status-dot" id="backupStatusDot"></div>
          </div>
        </div>
        <div class="status-card">
          <span class="status-icon">✅</span>
    ...
    <div id="errorModal" class="modal" style="display: none;">
      <div class="modal-content">
        ...
        <div class="modal-section">
          ...
          <div class="modal-body" id="backupActivity">
            <p>No backup activity recorded.</p>
          </div>
        </div>
        <div class="modal-footer">
          <button class="modal-btn" id="clearErrors">Clear Errors</button>
        </div>
      </div>
    </div>
  </div>
  ...
  const layers = [
    {
      ...
      color: '#00d4ff',
      label: 'Surface Layer',
      sub: 'file_ops · search_code · backup_restore · project_context · docs_manage · workflow_manage · sweobeyme_execute',
    },
    {
      id: 'core',
      y: 106,
      color: '#7b2fff',
      label: 'Core Layer',
      sub: 'Governance Router · Philosophy Enforcement · Self-Healing · Surgical Compliance',
    },
    {
      id: 'engine',
      y: 202,
      color: '#ff6b2b',
      label: 'Engine Layer',
      sub: 'Internal Handlers · Tool Arbitration · Rule Engine · Config Manager',
    },
    {
      id: 'validation',
      y: 298,
      ...
      sub: 'Structural · Safety · Router · Integration · Chaos Tests',
    },
    {
      id: 'soul',
      y: 394,
      color: '#ff3d71',
      label: 'Soul Layer',
      sub: 'Philosophy Firewall · Oracle · Ethics Guards · Governance Constitution',
    },
  ];
