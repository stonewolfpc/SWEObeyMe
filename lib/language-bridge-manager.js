...
export async function updateCppDiagnostics(document, diagnosticCollection, __dirname) {
  ...
  try {
    ...
    const analysisConfig = {
      severityThreshold: config.get('severityThreshold', 1), // Default to WARNING level
      confidenceThreshold: config.get('confidenceThreshold', 50), // Lower confidence threshold
