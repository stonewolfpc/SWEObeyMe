...
export async function searchLlamaDocsHandler(args) {
  ...
  const docsDir = path.join(path.join(__dirname, '..', '..'), 'ide_mcp_corpus');
...
export async function searchMathDocsHandler(args) {
  ...
  const mathDir = path.join(path.join(__dirname, '..', '..'), 'ide_mcp_corpus', 'math');
