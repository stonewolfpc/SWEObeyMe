...
import { getFDQToolDefinitions } from './registry-fdq.js';
import { getTrainingToolDefinitions } from './registry-training.js';
import { unifiedToolDefinitions } from './registry-unified.js';
...
export function getToolDefinitions() {
  const allTools = [
    ...
    ...getFDQToolDefinitions(),
    ...getTrainingToolDefinitions(),
