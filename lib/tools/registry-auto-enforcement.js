  ...
  return [
    {
      name: 'audit',
      priority: 97,
      description: 'Run pre-work audit, get audit status, or get issues. Use this when: starting new work, checking audit status, or reviewing detected issues. Helps prevent duplicate implementations and maintain project organization.',
      inputSchema: {
        type: 'object',
        properties: {
          operation: {
    ...
    },
    {
      ...
      priority: 96,
      description: 'Scan codebase for duplicate implementations, UI elements, or config issues. Use this when: finding duplicate code, duplicate UI panels, duplicate command IDs, or duplicate view IDs. Helps prevent duplicate implementations and maintain clean codebase.',
      inputSchema: {
        type: 'object',
        properties: {
