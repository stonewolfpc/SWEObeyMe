...
const CORPUS_REGISTRY = {
  unified: {
    ...
    listCategoriesHandler: async (args) => {
      const { unifiedHandlers } = await import('./unified-handlers.js');
      return unifiedHandlers.unified_list_categories(args);
    },
  },
  math: {
  ...
  fdq: {
    ...
    supportsCategories: true,
    listCategoriesHandler: fdq_list_categories_handler,
  },
  training: {
    ...
    supportsCategories: true,
    listCategoriesHandler: training_list_categories_handler,
  },
  godot: {
    name: 'Godot Engine',
