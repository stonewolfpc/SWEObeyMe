...
export const safetyHandlers = {
  ...
  confirm_dangerous_operation: async (args) => {
    try {
      ...
      return { isError: true, content: [{ type: "text", text: `Danger check failed: ${error.message}` }] };
    }
  },
  ...
  check_for_repetitive_patterns: async (args) => {
    try {
      ...
      return { isError: true, content: [{ type: "text", text: `Repetitive pattern check failed: ${error.message}` }] };
    }
  },
  ...
  check_test_coverage: async (args) => {
    try {
      ...
      return { isError: true, content: [{ type: "text", text: `Coverage check failed: ${error.message}` }] };
    }
  },
  ...
  run_related_tests: async (args) => {
    try {
      ...
      return { isError: true, content: [{ type: "text", text: `Test execution failed: ${error.message}` }] };
    }
  }
};
