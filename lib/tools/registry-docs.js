  ...
  return [
    {
      name: 'docs_lookup',
      priority: 85,
      description: 'MUST use this tool to search across ALL documentation corpora or a specific corpus. This is the ONLY way to access Unified Technical Documentation (C#/.NET, Git, TypeScript, etc.), Mathematical Reference, FDQ (LLM/Quantization), Training Dynamics, Godot Engine, and Llama.cpp/GGML documentation. Automatically searches all corpora unless a specific one is specified. Returns comprehensive results with corpus attribution.',
      inputSchema: {
        type: 'object',
        properties: {
          query: {
          ...
          corpus: {
            type: 'string',
            description: 'Optional: Specific corpus to search (unified, math, fdq, training, godot, llama). If omitted, searches ALL corpora.',
          },
          category: {
            type: 'string',
    ...
    },
    {
      ...
      priority: 84,
      description: 'MUST use this tool to see what documentation corpora are available. Lists all documentation collections including Unified Technical, Math, FDQ, Training, Godot, and Llama.cpp with descriptions and capabilities. Use this before docs_lookup to understand what documentation is accessible.',
      inputSchema: {
        type: 'object',
        properties: {},
      },
    },
    {
      ...
      priority: 83,
      description: 'MUST use this tool to list available categories within documentation corpora. Shows category hierarchies for corpora that support them (unified, math, fdq, training). Use this to understand the structure before searching with docs_lookup.',
      inputSchema: {
        type: 'object',
        properties: {
          corpus: {
            type: 'string',
            description: 'Optional: Specific corpus to list categories for. If omitted, lists categories for ALL corpora.',
          },
        },
      },
    },
    {
      name: 'docs_verify',
      priority: 88,
      description: 'MUST use this tool to verify mathematical formulas, algorithms, and technical claims BEFORE finalizing code. Performs symbolic checks, numerical tests, domain/range validation, invariants, and complexity analysis. Consolidates math verification and can be extended for other verification types. Returns pass/fail with detailed reasoning and counterexamples.',
      inputSchema: {
        type: 'object',
        properties: {
          formula: {
