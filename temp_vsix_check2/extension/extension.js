...
function checkAndInstallMCP() {
  ...
  const indexPath = path.join(extensionPath, 'index.mjs');

  console.log('SWEObeyMe: Looking for index.mjs at:', indexPath);

  if (!fs.existsSync(indexPath)) {
    console.error('SWEObeyMe: index.mjs not found at:', indexPath);
    console.log(
    ...
    vscode.window
      .showErrorMessage(
        'SWEObeyMe: index.mjs not found in extension. Please report this issue.',
