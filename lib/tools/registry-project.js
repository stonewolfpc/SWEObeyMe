  ...
  return [
    {
      name: 'project_memory',
      priority: 75,
      description: 'PROJECT MEMORY SWISS-ARMY-KNIFE - Index structure, analyze conventions, get summary, record decisions, or suggest file locations. This is your swiss-army-knife for project awareness. Use this when: starting work on a new project, analyzing conventions, getting project summary, recording decisions, or determining where to place new files. CRITICAL for anti-hallucination and proper project awareness. Example: project_memory with operation="summary" at start of session to avoid repeating past mistakes.',
      inputSchema: {
        type: 'object',
        properties: {
          operation: {
          ...
          purpose: { type: 'string', description: 'File purpose (for "suggest_location" operation)' },
        },
        required: ['operation'],
      },
    },
