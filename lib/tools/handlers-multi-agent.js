  ...
  agent_spawn: async args => {
    ...
    if (!name || !task) {
      return {
        isError: true,
        content: [
          { type: 'text', text: 'name and task are required' },
        ],
      };
    }
  ...
  agent_start: async args => {
    ...
    try {
      ...
      return {
        isError: true,
        content: [
          { type: 'text', text: `Failed to start agent: ${error.message}` },
        ],
      };
    }
  },
  ...
  agent_pause: async args => {
    ...
    try {
      ...
      return {
        isError: true,
        content: [
          { type: 'text', text: `Failed to pause agent: ${error.message}` },
        ],
      };
    }
  },
  ...
  agent_resume: async args => {
    ...
    try {
      ...
      return {
        isError: true,
        content: [
          { type: 'text', text: `Failed to resume agent: ${error.message}` },
        ],
      };
    }
  },
  ...
  agent_terminate: async args => {
    ...
    try {
      ...
      return {
        isError: true,
        content: [
          { type: 'text', text: `Failed to terminate agent: ${error.message}` },
        ],
      };
    }
  },
  ...
  agent_dashboard: async args => {
    try {
      ...
      return {
        isError: true,
        content: [
          { type: 'text', text: `Failed to get dashboard: ${error.message}` },
        ],
      };
    }
  },
  ...
  agent_details: async args => {
    ...
    try {
      ...
      return {
        isError: true,
        content: [
          { type: 'text', text: `Failed to get agent details: ${error.message}` },
        ],
      };
    }
  },
  ...
  agent_execute_parallel: async args => {
    ...
    if (!agent_ids || !Array.isArray(agent_ids)) {
      return {
        isError: true,
        content: [
          { type: 'text', text: 'agent_ids (array) is required' },
        ],
      };
    }
    ...
    try {
      ...
      return {
        isError: true,
        content: [
          { type: 'text', text: `Failed to execute parallel: ${error.message}` },
        ],
      };
    }
  },
  ...
  agent_clear_completed: async args => {
    try {
      ...
      return {
        isError: true,
        content: [
          { type: 'text', text: `Failed to clear completed: ${error.message}` },
        ],
      };
    }
  },
