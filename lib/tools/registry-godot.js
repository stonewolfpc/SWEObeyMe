  ...
  return [
    {
      ...
      description: 'Detect if a project is a Godot project before making Godot-specific changes. Identifies Godot projects by checking for project.godot, .godot folder, GDScript files, and Godot directory structure. Returns project type (2D/3D/mixed), Godot version, and whether GDScript files are present.',
      inputSchema: {
        type: 'object',
        properties: {
          projectPath: {
