  ...
  return [
    {
      name: 'docs_lookup',
      priority: 85,
      description: 'Search across ALL documentation corpora or a specific corpus. Access Unified Technical Documentation (C#/.NET, Git, TypeScript, etc.), Mathematical Reference, FDQ (LLM/Quantization), Training Dynamics, Godot Engine, and Llama.cpp/GGML documentation. Automatically searches all corpora unless a specific one is specified. Returns comprehensive results with corpus attribution.',
      inputSchema: {
        type: 'object',
        properties: {
          query: {
    ...
    },
    {
      ...
      priority: 84,
      description: 'List all documentation corpora available. Shows Unified Technical, Math, FDQ, Training, Godot, and Llama.cpp collections with descriptions and capabilities. Use this before docs_lookup to understand what documentation is accessible.',
      inputSchema: {
        type: 'object',
        properties: {},
      },
    },
    {
      ...
      priority: 83,
      description: 'List available categories within documentation corpora. Shows category hierarchies for corpora that support them (unified, math, fdq, training). Use this to understand the structure before searching with docs_lookup.',
      inputSchema: {
        type: 'object',
        properties: {
          corpus: {
